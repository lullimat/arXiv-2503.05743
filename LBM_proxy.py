...
class PShanChenMultiPhase(ShanChenMultiPhase):
    ...
    def MainLoopSCFMod(self, time_steps, convergence_functions = []):
        _all_init = []
        for key in self.init_status:
            _all_init.append(self.init_status[key])
        ...
        _K_Collision_ShanChenMultiPhaseMod = \
            K_Collision_ShanChenMultiPhaseMod(custom_types = self.custom_types.Push(),
                                              constants = self.constants,
                                              f_classes = [F_PosFromIndex,
                                                           F_IndexFromPos],
                                              optimizer_flag = self.optimizer_flag)
            ...
            IdpyLoop(
                ...
                [
                    [
                        ...
                        (_K_Collision_ShanChenMultiPhaseMod(tenet = self.tenet,
                                                            grid = self.sims_vars['grid'],
                                                            block = self.sims_vars['block']),
                         ['pop', 'u', 'n', 'psi',
                          'XI_list', 'W_list',
    ...
    def MainLoopSCFEq4(self, time_steps, convergence_functions = []):
        _all_init = []
        for key in self.init_status:
            _all_init.append(self.init_status[key])
        ...
        _K_Collision_ShanChenMultiPhaseEq4 = \
            K_Collision_ShanChenMultiPhaseEq4(custom_types = self.custom_types.Push(),
                                           constants = self.constants,
                                           f_classes = [F_PosFromIndex,
                                                        F_IndexFromPos],
                                           optimizer_flag = self.optimizer_flag)
            ...
            IdpyLoop(
                ...
                [
                    [
                        ...
                        (_K_Collision_ShanChenMultiPhaseEq4(tenet = self.tenet,
                                                         grid = self.sims_vars['grid'],
                                                         block = self.sims_vars['block']),
                         ['pop', 'u', 'n', 'psi',
                          'XI_list', 'W_list',
    ...
    def MainLoopKSFEq4(self, time_steps, convergence_functions = []):
        _all_init = []
        for key in self.init_status:
            _all_init.append(self.init_status[key])
        ...
        _K_Collision_KupershtokhEq4 = \
            K_Collision_KupershtokhEq4(custom_types = self.custom_types.Push(),
                                    constants = self.constants,
                                    f_classes = [F_PosFromIndex,
                                                 F_IndexFromPos],
                                    optimizer_flag = self.optimizer_flag)
            ...
            IdpyLoop(
                ...
                [
                    [
                        ...
                        (_K_Collision_KupershtokhEq4(tenet = self.tenet,
                                                  grid = self.sims_vars['grid'],
                                                  block = self.sims_vars['block']),
                         ['pop', 'u', 'n', 'psi',
                          'XI_list', 'W_list',
    ...
    def MainLoopGuo4(self, time_steps, convergence_functions = []):
        _all_init = []
        for key in self.init_status:
            _all_init.append(self.init_status[key])
        ...
        _K_Collision_Guo4 = \
            K_Collision_Guo4(custom_types = self.custom_types.Push(),
                                    constants = self.constants,
                                    f_classes = [F_PosFromIndex,
                                                 F_IndexFromPos],
                                    optimizer_flag = self.optimizer_flag)
            ...
            IdpyLoop(
                ...
                [
                    [
                        ...
                        (_K_Collision_Guo4(tenet = self.tenet,
                                                  grid = self.sims_vars['grid'],
                                                  block = self.sims_vars['block']),
                         ['pop', 'u', 'n', 'psi',
                          'XI_list', 'W_list',
    ...
    def MainLoopGuo2Eq4(self, time_steps, convergence_functions = []):
        _all_init = []
        for key in self.init_status:
            _all_init.append(self.init_status[key])
        ...
        _K_Collision_Guo2Eq4 = \
            K_Collision_Guo2Eq4(custom_types = self.custom_types.Push(),
                                    constants = self.constants,
                                    f_classes = [F_PosFromIndex,
                                                 F_IndexFromPos],
                                    optimizer_flag = self.optimizer_flag)
            ...
            IdpyLoop(
                ...
                [
                    [
                        ...
                        (_K_Collision_Guo2Eq4(tenet = self.tenet,
                                                  grid = self.sims_vars['grid'],
                                                  block = self.sims_vars['block']),
                         ['pop', 'u', 'n', 'psi',
                          'XI_list', 'W_list',
    ...
    def MainLoopHe2(self, time_steps, convergence_functions = []):
        _all_init = []
        for key in self.init_status:
            _all_init.append(self.init_status[key])
        ...
        _K_Collision_He2 = \
            K_Collision_He2(custom_types = self.custom_types.Push(),
                                    constants = self.constants,
                                    f_classes = [F_PosFromIndex,
                                                 F_IndexFromPos],
                                    optimizer_flag = self.optimizer_flag)
            ...
            IdpyLoop(
                ...
                [
                    [
                        ...
                        (_K_Collision_He2(tenet = self.tenet,
                                                  grid = self.sims_vars['grid'],
                                                  block = self.sims_vars['block']),
                         ['pop', 'u', 'n', 'psi',
                          'XI_list', 'W_list',
    ...
    def MainLoopHe4(self, time_steps, convergence_functions = []):
        _all_init = []
        for key in self.init_status:
            _all_init.append(self.init_status[key])
        ...
        _K_Collision_He4 = \
            K_Collision_He4(custom_types = self.custom_types.Push(),
                                    constants = self.constants,
                                    f_classes = [F_PosFromIndex,
                                                 F_IndexFromPos],
                                    optimizer_flag = self.optimizer_flag)
            ...
            IdpyLoop(
                ...
                [
                    [
                        ...
                        (_K_Collision_He4(tenet = self.tenet,
                                                  grid = self.sims_vars['grid'],
                                                  block = self.sims_vars['block']),
                         ['pop', 'u', 'n', 'psi',
                          'XI_list', 'W_list',
    ...
    def MainLoopHe2Eq4(self, time_steps, convergence_functions = []):
        _all_init = []
        for key in self.init_status:
            _all_init.append(self.init_status[key])
        ...
        _K_Collision_He2Eq4 = \
            K_Collision_He2Eq4(custom_types = self.custom_types.Push(),
                                    constants = self.constants,
                                    f_classes = [F_PosFromIndex,
                                                 F_IndexFromPos],
                                    optimizer_flag = self.optimizer_flag)
            ...
            IdpyLoop(
                ...
                [
                    [
                        ...
                        (_K_Collision_He2Eq4(tenet = self.tenet,
                                                  grid = self.sims_vars['grid'],
                                                  block = self.sims_vars['block']),
                         ['pop', 'u', 'n', 'psi',
                          'XI_list', 'W_list',
...
class K_Collision_ShanChenMultiPhaseMod(IdpyKernel):
    def __init__(self, custom_types = {}, constants = {}, f_classes = [],
                 optimizer_flag = None):
        IdpyKernel.__init__(self, custom_types = custom_types,
                            constants = constants, f_classes = f_classes,
        ...
        if(g_tid < V){
            ...
            SCFType F2 = 0.;
            for(int d=0; d<DIM; d++){F[d] *= -SC_G * lpsi; F2 += F[d] * F[d]; }
            ...
            for(int q=0; q<Q; q++){
                ...
                lg_pop = - 0.5 * W_list[q] * ((1. - 0.5 * OMEGA) * (1. - 0.5 * OMEGA)) / ln / OMEGA;
                lg_pop *= (CM4 * F_dot_xi * F_dot_xi - CM2 * F2);

                pop[g_tid + q*V] = \
                    pop[g_tid + q*V]*(1. - OMEGA) + leq_pop*OMEGA + lg_pop;
...
class K_Collision_ShanChenMultiPhaseEq4(IdpyKernel):
    def __init__(self, custom_types = {}, constants = {}, f_classes = [],
                 optimizer_flag = None):
        IdpyKernel.__init__(self, custom_types = custom_types,
                            constants = constants, f_classes = f_classes,
        ...
        if(g_tid < V){
            ...
            for(int q=0; q<Q; q++){
                ...
                PopType leq4_pop = 1.;
                UType H21 = 0., H12 = 0., H22 = 0.;
                H21 = (XI_list[0 + q*DIM]*XI_list[0 + q*DIM] - 1/CM2)*XI_list[1 + q*DIM];
                H12 = (XI_list[1 + q*DIM]*XI_list[1 + q*DIM] - 1/CM2)*XI_list[0 + q*DIM];
                H22 = (XI_list[0 + q*DIM]*XI_list[0 + q*DIM] - 1/CM2)*(XI_list[1 + q*DIM]*XI_list[1 + q*DIM] - 1/CM2);

                // Equilibrium population with shifted velocity
                leq4_pop += + u_dot_xi*CM2 + 0.5*u_dot_xi*u_dot_xi*CM4;
                leq4_pop += - 0.5*u_dot_u*CM2;
                leq4_pop += + 0.5*(H21*lu[0]*lu[0]*lu[1]) * CM2*CM4;
                leq4_pop += + 0.5*(H12*lu[0]*lu[1]*lu[1]) * CM2*CM4;
                leq4_pop += + 0.25*(H22*lu[0]*lu[0]*lu[1]*lu[1]) * CM4*CM4;
                leq4_pop = leq4_pop * ln * W_list[q];

                pop[g_tid + q*V] = \
                    pop[g_tid + q*V]*(1. - OMEGA) + leq4_pop*OMEGA;
...
class K_Collision_KupershtokhEq4(IdpyKernel):
    def __init__(self, custom_types = {}, constants = {}, f_classes = [],
                 optimizer_flag = None):
        IdpyKernel.__init__(self, custom_types = custom_types,
                            constants = constants, f_classes = f_classes,
        ...
        if(g_tid < V){
            ...
            for(int q=0; q<Q; q++){
                ...
                PopType leq4_pop = 1.; PopType leq4_pop_bare = 1.;
                UType H21 = 0., H12 = 0., H22 = 0.;
                H21 = (XI_list[0 + q*DIM]*XI_list[0 + q*DIM] - 1/CM2)*XI_list[1 + q*DIM];
                H12 = (XI_list[1 + q*DIM]*XI_list[1 + q*DIM] - 1/CM2)*XI_list[0 + q*DIM];
                H22 = (XI_list[0 + q*DIM]*XI_list[0 + q*DIM] - 1/CM2)*(XI_list[1 + q*DIM]*XI_list[1 + q*DIM] - 1/CM2);
                ...
                // Equilibrium population with no-shifted velocity
                leq4_pop_bare += + u_dot_xi_bare*CM2 + 0.5*u_dot_xi_bare*u_dot_xi_bare*CM4;
                leq4_pop_bare += - 0.5*u_dot_u_bare*CM2;
                leq4_pop_bare += + 0.5*(H21*lu_bare[0]*lu_bare[0]*lu_bare[1]) * CM2*CM4;
                leq4_pop_bare += + 0.5*(H12*lu_bare[0]*lu_bare[1]*lu_bare[1]) * CM2*CM4;
                leq4_pop_bare += + 0.25*(H22*lu_bare[0]*lu_bare[0]*lu_bare[1]*lu_bare[1]) * CM4*CM4;
                leq4_pop_bare = leq4_pop_bare * ln * W_list[q];

                pop[g_tid + q*V] = \
                    pop[g_tid + q*V]*(1. - OMEGA) - leq4_pop_bare*(1. - OMEGA) + leq4_pop;
...
class K_Collision_Guo2Eq4(IdpyKernel):
    def __init__(self, custom_types = {}, constants = {}, f_classes = [],
                 optimizer_flag = None):
        IdpyKernel.__init__(self, custom_types = custom_types,
                            constants = constants, f_classes = f_classes,
        ...
        if(g_tid < V){
            ...
            for(int q=0; q<Q; q++){
                ...
                PopType leq4_pop = 1., lguo2_pop = 0.;
                ...
                // Guo population
                lguo2_pop += + F_dot_xi*CM2 + F_dot_xi*u_dot_xi*CM4;
                lguo2_pop += - F_dot_u*CM2;
                lguo2_pop = lguo2_pop * W_list[q];

                pop[g_tid + q*V] = \
                    pop[g_tid + q*V]*(1. - OMEGA) + leq4_pop*OMEGA + (1. - 0.5 * OMEGA) * lguo2_pop;

             }
        }
        """

class K_Collision_Guo4(IdpyKernel):
    def __init__(self, custom_types = {}, constants = {}, f_classes = [],
                 optimizer_flag = None):
        IdpyKernel.__init__(self, custom_types = custom_types,
                            constants = constants, f_classes = f_classes,
        ...
        if(g_tid < V){
            ...
            for(int q=0; q<Q; q++){
                ...
                leq_pop += + u_dot_xi*CM2 + 0.5*u_dot_xi*u_dot_xi*CM4;
                leq_pop += - 0.5*u_dot_u*CM2;
                leq_pop += + 0.5*(H21*lu[0]*lu[0]*lu[1]) * CM2*CM4;
                leq_pop += + 0.5*(H12*lu[0]*lu[1]*lu[1]) * CM2*CM4;
                leq_pop += + 0.25*(H22*lu[0]*lu[0]*lu[1]*lu[1]) * CM4*CM4;
                leq_pop = leq_pop * ln * W_list[q];

                // Guo population
                lguo_pop += + F_dot_xi*CM2 + F_dot_xi*u_dot_xi*CM4;
                lguo_pop += - F_dot_u*CM2;
                lguo_pop += + 0.5 * H21 * ( 2.*F[0]*lu[0]*lu[1]+F[1]*lu[0]*lu[0] ) * CM4*CM2;
                lguo_pop += + 0.5 * H12 * ( 2.*F[1]*lu[1]*lu[0]+F[0]*lu[1]*lu[1] ) * CM4*CM2;
                lguo_pop += + 0.5 * H22 * ( F[0]*lu[0]*lu[1]*lu[1]+F[1]*lu[1]*lu[0]*lu[0] ) * CM4*CM4;
...
class K_Collision_He2(IdpyKernel):
    def __init__(self, custom_types = {}, constants = {}, f_classes = [],
                 optimizer_flag = None):
        IdpyKernel.__init__(self, custom_types = custom_types,
                            constants = constants, f_classes = f_classes,
        ...
        if(g_tid < V){
            ...
            // Local density and velocity for He velocity shift and equilibrium
            NType ln = n[g_tid]; UType lu[DIM];

            // He velocity shift & Copy to global memory
            for(int d=0; d<DIM; d++){ 
                lu[d] = u[g_tid + V*d] + 0.5 * F[d]/ln;
                u[g_tid + V*d] = lu[d];
            }

            // Compute square norm of He shifted velocity
            UType u_dot_u = 0., F_dot_u = 0.;
            for(int d=0; d<DIM; d++){u_dot_u += lu[d]*lu[d]; F_dot_u  += F[d] * lu[d];}

            // Cycle over the populations: equilibrium + He (2nd-order formulation)
            for(int q=0; q<Q; q++){
                UType u_dot_xi = 0., F_dot_xi = 0.; 
                for(int d=0; d<DIM; d++){
                    F_dot_xi += F[d] * XI_list[d + q*DIM];
                ...
                PopType leq_pop = 1., lhe_pop = 0.;

                // Equilibrium population (2nd-order formulation)
                leq_pop += + u_dot_xi*CM2 + 0.5*u_dot_xi*u_dot_xi*CM4;
                leq_pop += - 0.5*u_dot_u*CM2;
                leq_pop = leq_pop * ln * W_list[q];

                // He population (2nd-order formulation)
                lhe_pop += + F_dot_xi*CM2;
                lhe_pop += - F_dot_u *CM2;
                lhe_pop = lhe_pop * (leq_pop / ln);

                pop[g_tid + q*V] = \
                    pop[g_tid + q*V]*(1. - OMEGA) + leq_pop*OMEGA + (1. - 0.5 * OMEGA) * lhe_pop;

             }
        }
        """

class K_Collision_He2Eq4(IdpyKernel):
    def __init__(self, custom_types = {}, constants = {}, f_classes = [],
                 optimizer_flag = None):
        IdpyKernel.__init__(self, custom_types = custom_types,
                            constants = constants, f_classes = f_classes,
        ...
        if(g_tid < V){
            ...
            // Cycle over the populations: equilibrium + He (4th-order formulation)
            for(int q=0; q<Q; q++){
                UType u_dot_xi = 0., F_dot_xi = 0.; 
                for(int d=0; d<DIM; d++){
                    F_dot_xi += F[d] * XI_list[d + q*DIM];
                ...
                PopType leq2_pop = 1., leq4_pop = 1., lhe_pop = 0.;

                // Equilibrium population (4th-order formulation)
                UType H21 = 0., H12 = 0., H22 = 0.;
                H21 = (XI_list[0 + q*DIM]*XI_list[0 + q*DIM] - 1/CM2)*XI_list[1 + q*DIM];
                H12 = (XI_list[1 + q*DIM]*XI_list[1 + q*DIM] - 1/CM2)*XI_list[0 + q*DIM];
                H22 = (XI_list[0 + q*DIM]*XI_list[0 + q*DIM] - 1/CM2)*(XI_list[1 + q*DIM]*XI_list[1 + q*DIM] - 1/CM2);

                leq2_pop += + u_dot_xi*CM2 + 0.5*u_dot_xi*u_dot_xi*CM4;
                leq2_pop += - 0.5*u_dot_u*CM2;
                ...
                leq2_pop = leq2_pop * ln * W_list[q];
                leq4_pop = leq4_pop * ln * W_list[q];

                // He population (2nd-order formulation)
                lhe_pop += + F_dot_xi*CM2;
                lhe_pop += - F_dot_u *CM2;
                lhe_pop = lhe_pop * (leq2_pop / ln);

                pop[g_tid + q*V] = \
                    pop[g_tid + q*V]*(1. - OMEGA) + leq4_pop*OMEGA + (1. - 0.5 * OMEGA) * lhe_pop;

             }
        }
        """

class K_Collision_He4(IdpyKernel):
    def __init__(self, custom_types = {}, constants = {}, f_classes = [],
                 optimizer_flag = None):
        IdpyKernel.__init__(self, custom_types = custom_types,
                            constants = constants, f_classes = f_classes,
...
<<<<<<< HEAD
                // He population (4th-order formulation)
                lhe_pop += + F_dot_xi*CM2;
                lhe_pop += - F_dot_u *CM2;
                lhe_pop = lhe_pop * (leq_pop / ln);
=======
                ...
                leq_pop_bare += - 0.5*u_dot_u_bare*CM2;
                leq_pop_bare = leq_pop_bare * ln * W_list[q];
>>>>>>> 6b786865fb090a128ea86fcedf060ea665292d2c
